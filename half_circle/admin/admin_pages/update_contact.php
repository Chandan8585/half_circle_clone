...
<html>
 ...
 <div id='content'>
    <h1>Update Our Ventures Page from Here</h1>
 <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
  ...
  <ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link text-dark" id="iconbox-tab" data-toggle="tab" href="#paragraph" role="tab" aria-controls="paragraph" aria-selected="false">Paragraph</a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-dark" id="carousels-tab" data-toggle="tab" href="#carousels" role="tab" aria-controls="carousels" aria-selected="false">carousel</a>
    </li>
  ...
  <div class="tab-content mt-2" id="myTabContent">
    ...
    <button type="submit" class="btn btn-primary mt-3">Submit</button>
       ...
       <!-- Paragraphs Tab -->
    <div class="tab-pane fade" class="tab-pane fade show active" id="iconbox" role="tabpanel" aria-labelledby="iconbox-tab">
        <h2>Icon Box</h2>
        
        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
            <!-- Nav tabs for Paragraphs -->
            <ul class="nav nav-tabs" id="iconbox-tab" role="tablist">
                <?php foreach ($jsonData['icon_box'] as $index => $iconbox) { ?>
                    <li class="nav-item">
                        <a class="nav-link text-dark <?php echo $index === 0 ? 'active' : ''; ?>" id="paragraph-tab-<?php echo $index; ?>" data-toggle="tab" href="#paragraph<?php echo $index; ?>" role="tab" aria-controls="paragraph<?php echo $index; ?>" aria-selected="<?php echo $index === 0 ? 'true' : 'false'; ?>">Iconbox <?php echo $index + 1; ?></a>
                    </li>
                <?php } ?>
            </ul>
    ...
    <div class="tab-pane fade" id="carousels" role="tabpanel" aria-labelledby="carousels-tab">
    <h2>Carousel</h2>
    
    <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
        <!-- Nav tabs for carousels -->
        <ul class="nav nav-tabs" id="carouselTab" role="tablist">
            <?php foreach ($jsonData['carousel'] as $index => $carousel) { ?>
                <li class="nav-item">
                    <a class="nav-link text-dark <?php echo $index === 0 ? 'active' : ''; ?>" id="carousel-tab-<?php echo $index; ?>" data-toggle="tab" href="#carousel<?php echo $index; ?>" role="tab" aria-controls="carousel<?php echo $index; ?>" aria-selected="<?php echo $index === 0 ? 'true' : 'false'; ?>">carousel <?php echo $index + 1; ?></a>
                </li>
            <?php } ?>
        </ul>

        <!-- Tab panes for carousels -->
        <div class="tab-content" id="carouselTabContent">
            <?php foreach ($jsonData['carousel'] as $index => $carousel) { ?>
                <div class="tab-pane fade  <?php echo $index === 0 ? 'show active' : ''; ?>" id="carousel<?php echo $index; ?>" role="tabpanel" aria-labelledby="carousel-tab-<?php echo $index; ?>">
                    <h3>carousel <?php echo $index + 1; ?></h3>
                    <div class="form-group">
                        <label for="carousel_url1<?php echo $index; ?>">Title:</label>
                        <input type="text" class="form-control" id="carousel_url1<?php echo $index; ?>" name="carousel[<?php echo $index; ?>][url1]" value="<?php echo htmlspecialchars($carousel['url1']); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="carousel_url2<?php echo $index; ?>">Content:</label>
                        <textarea class="form-control" id="carousel_url2<?php echo $index; ?>" name="carousel[<?php echo $index; ?>][url2]" rows="4" required><?php echo htmlspecialchars($carousel['url2']); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="carousel_url3<?php echo $index; ?>">Content:</label>
                        <textarea class="form-control" id="carousel_url3<?php echo $index; ?>" name="carousel[<?php echo $index; ?>][url3]" rows="4" required><?php echo htmlspecialchars($carousel['url3']); ?></textarea>
                    </div>
                </div>
            <?php } ?>
        </div>
